...
export type PdpBlockUnion =
    | PdpBlockAvailability
    | PdpBlockName
    | PdpBlockPrice
    | PdpDescriptionBlock
    | PdpLabelsBlock
...
export type PrinterBlocksUnion =
    | CloudshelfDetailsPrinterBlock
    | DeviceDetailsPrinterBlock
    | FulfilmentDetailsPrinterBlock
    | LocationDetailsPrinterBlock
    | OrderDetailsPrinterBlock
    | OrderReferencePrinterBlock
    | PaymentDetailsPrinterBlock
    | PrecutPrinterBlock
    | SalesAssistantDetailsPrinterBlock
    | SpacerPrinterBlock
    | TextPrinterBlock
    | TimestampPrinterBlock;
...
export const UpdateProductsInProductGroupInBatchDocument = gql`
    mutation UpdateProductsInProductGroupInBatch($productGroupUpdateBatchInput: ProductGroupUpdateBatch!) {
        updateProductsInProductGroupInBatch(productGroupUpdateBatchInput: $productGroupUpdateBatchInput) {
            success
            productGroupId
            number
        }
...
export type UpsertLocationsMutation = {
    __typename?: 'Mutation';
    upsertLocations: {
        __typename?: 'LocationUpsertPayload';
        locations: Array<{ __typename?: 'Location'; id: any; platformProvidedId?: any | null }>;
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
    };
};
...
export type UpsertStoreMutation = {
    __typename?: 'Mutation';
    upsertShopifyOrganisation: {
        __typename?: 'OrganisationUpsertPayload';
        organisation?: { __typename?: 'Organisation'; id: any } | null;
        userErrors: Array<{ __typename?: 'UserError'; message: string; code: UserErrorCode }>;
    };
};
...
export type UpsertCloudshelfMutation = {
    __typename?: 'Mutation';
    upsertCloudshelves: {
        __typename?: 'CloudshelfUpsertPayload';
        cloudshelves: Array<{ __typename?: 'Cloudshelf'; id: any }>;
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
    };
};
...
export type UpsertOrdersMutation = {
    __typename?: 'Mutation';
    upsertOrders: {
        __typename?: 'OrderUpsertPayload';
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
        orders: Array<{ __typename?: 'Order'; id: any }>;
    };
};
...
export type UpsertProductGroupsMutation = {
    __typename?: 'Mutation';
    upsertProductGroups: {
        __typename?: 'ProductGroupUpsertPayload';
        productGroups: Array<{ __typename?: 'ProductGroup'; id: any }>;
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
    };
};
...
export type DeleteProductGroupsMutation = {
    __typename?: 'Mutation';
    deleteProductGroups: {
        __typename?: 'ProductGroupDeletePayload';
        productGroups: Array<{ __typename?: 'ProductGroup'; id: any }>;
...
export type KeepKnownProductGroupsViaFileMutation = {
    __typename?: 'Mutation';
...
export type UpdateProductsInProductGroupInBatchMutation = {
    __typename?: 'Mutation';
    updateProductsInProductGroupInBatch: Array<{
        __typename?: 'ProductGroupUpdateBatchPayload';
        success: boolean;
        productGroupId: any;
        number: number;
...
export type UpsertProductsMutation = {
    ...
    upsertProducts: {
        __typename?: 'ProductUpsertPayload';
        products: Array<{ __typename?: 'Product'; id: any }>;
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
    };
};
...
export type UpsertProductVariantsMutation = {
    ...
    upsertProductVariants: {
        __typename?: 'ProductVariantUpsertPayload';
        productVariants: Array<{ __typename?: 'ProductVariant'; id: any }>;
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
    };
};
...
export type KeepKnownProductsViaFileMutation = {
    __typename?: 'Mutation';
...
export type UpsertStockLevelsMutation = {
    __typename?: 'Mutation';
    upsertStockLevels: {
        __typename?: 'StockLevelUpsertPayload';
        stockLevels: Array<{ __typename?: 'StockLevel'; id: any }>;
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
    };
};
...
export type RequestShopifySubscriptionCheckMutation = {
    __typename?: 'Mutation';
    requestShopifySubscriptionCheck: boolean;
};
...
export type UpsertThemeMutation = {
    __typename?: 'Mutation';
    upsertTheme: {
        __typename?: 'ThemeUpsertPayload';
        userErrors: Array<{ __typename?: 'UserError'; code: UserErrorCode; message: string }>;
        theme?: { __typename?: 'Theme'; id: any } | null;
    };
};
...
export type KeepKnownVariantsViaFileMutation = {
    __typename?: 'Mutation';
...
export type OrganisationSyncStatusByDomainQuery = {
    __typename?: 'Query';
...
`;
export type ReportTriggerJobStartedMutation = { __typename?: 'Mutation'; reportTriggerJobStarted: boolean };
export type ReportTriggerJobStartedMutationVariables = Exact<{
    taskId: Scalars['String']['input'];
    runId: Scalars['String']['input'];
}>;
