...
export class Migration20240122143704 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "custom_token" ("id" varchar(255) not null, "shop" varchar(255) not null, "token" varchar(1000) not null, constraint "custom_token_pkey" primary key ("id"));');
