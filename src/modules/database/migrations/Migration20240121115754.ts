...
export class Migration20240121115754 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "shopify_sessions" ("id" varchar(255) not null, "shop" varchar(255) not null, "state" varchar(255) not null, "is_online" boolean not null, "scope" varchar(255) null, "expires" timestamptz null, "access_token" varchar(255) null, "online_access_info" jsonb null, constraint "shopify_sessions_pkey" primary key ("id"));');
  }
